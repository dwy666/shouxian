<template>
  <div id="addUser">
      ...
      <el-scrollbar>
        <div class="dialogMain">
          <el-form class="clearfix" ref="form" :model="form" label-width="85px">
            <el-form-item v-if="teamType != 'D' && isAdd !='bulkImport'" label="上级编码：">
              <el-input v-model="form.name" disabled></el-input>
            </el-form-item>
            <el-form-item v-if="teamType != 'D' && isAdd !='bulkImport' &&isAdd == 'lookInfo'" label="上级名称：">
              <el-input v-model="form.name" disabled></el-input>
            </el-form-item>
            <el-form-item v-if="teamType != 'D' && isAdd !='bulkImport' &&isAdd == 'lookInfo'" label="团队编码：">
              <el-input v-model="form.name" disabled></el-input>
            </el-form-item>
            <el-form-item v-if="teamType != 'D'&& isAdd !='bulkImport'" label="团队级别：">
              <el-input v-model="form.name" disabled></el-input>
            </el-form-item>
            <el-form-item v-if="(isAdd == 'lookInfo' &&teamType != 'D') &&isAdd !='bulkImport'" label="登陆手机号：">
              <el-input v-model="form.name" disabled></el-input>
            </el-form-item>
            ...
            <el-form-item v-if=" isAdd =='bulkImport'" label="批量文件：">
              <span class="uploadFiles">
                ...
                <span style="vertical-align: middle;">上传成功</span>
              </span>
              <div></div>
            ...
            <el-form-item v-if="isAdd == 'addTeam' || isMessage && isAdd =='bulkImport'" label="请选择下发短信模版：" style="width:103%" label-width="82px">
              <div
    ...
    <div class="dialogFooter" v-if="teamType != 'D'">
      <el-checkbox :disabled="teamIsTestify=='2'?true:false||teamType== 'C'?false:true" v-model="checked" :checked="teamType== 'C'?false:true">对该账户开通平台操作权限</el-checkbox>
    </div>
  </div>
</template>
<script>
