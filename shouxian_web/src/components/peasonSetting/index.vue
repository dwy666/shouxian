  ...
  <div id="peasonSetting">
    <el-container>
      <el-aside width="230px">
        <el-tree v-if="treeData.length != 0" :data="treeData" @node-click="handleNodeClick" accordion>
        ...
        <el-main>
          ...
          <div class="userForm">
            <el-table :data="tableData" style="width: 100%">
              ...
              <el-table-column class-name="operation" prop="operation" label="操作" align="center"></el-table-column>
            </el-table>
          </div>
          <el-pagination
